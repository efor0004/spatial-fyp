...
public class WildHandler : MonoBehaviour
{
    //the script that controls all of the puzzles in the Wild scene
   ...
   // int PuzzlesPerLevel = 5;
    ...
    void Start()
    {
        ...
        {
            int n;
            n = (Global.WildLevel - 1) * 5 + Global.WildPuzzle;              //index of array = puzzle number -1
    ...
    void Puzzle1()
    {
        ...
        //spawn target image
        Global.RenderPuzzleImage("WP1");  //has the touchrotate script attached --> run after all shapes are loaded
