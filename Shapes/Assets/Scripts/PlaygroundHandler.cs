...
public class PlaygroundHandler : MonoBehaviour
{
    ...
    //    Global.ProgressBar(Global.PuzzlesPerLevel, Global.PlaygroundPuzzle - 1, Mask, LevelText, Global.PlaygroundLevel); //updates the progress bar
    ...
    //    //spawn target image
    //    Global.RenderPuzzleImage("PG1");  //has the touchrotate script attached --> run after all shapes are loaded
