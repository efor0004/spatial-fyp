...
public class TouchRotateDiamondYellow : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Debug.Log("Diamond Yellow position: " + shapeLoc + "\n");
    }
    ...
    void Update()
    {
        ...
        if (Input.touchCount == 2 & Active == true)  
        {
            ...
            //Debug.Log("yellow diamond position x " + transform.position.x + " \n");
            //Debug.Log("yellow diamond position y " + transform.position.y + " \n");
            //Debug.Log("yellow diamond orientation z" + transform.rotation.z + " \n");
            ...
            { // rotate
                ...
                //adapted code from https://answers.unity.com/questions/991083/dragging-a-2d-sprite-with-touch.html
        ...
        {
           Vector3 shadowPos = GameObject.Find("DiamondYellowShadow").transform.position;
           Quaternion shadowRot = GameObject.Find("DiamondYellowShadow").transform.rotation;
